    ...
    <div className={styles.section}>
      ...
      <form className={styles.form} onSubmit={handleSubmit}>
        <div className={styles.fields}>
          <Input label="name" options={{value: displayName, name: 'displayName', onChange: handleChange, required: true }} />
          ...
          <Input label="confirm password" options={{ value: confirmPassword, name: 'confirmPassword', onChange: handleChange, required: true }}/>
        </div>
